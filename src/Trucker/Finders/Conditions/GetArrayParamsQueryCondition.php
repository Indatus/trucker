...
class GetArrayParamsQueryCondition implements QueryConditionInterface
{
    ...
    {
        return config('trucker.query_condition.get_array_params.and_operator');
    }
    ...
    {
        return config('trucker.query_condition.get_array_params.or_operator');
    }
    ...
    public function addToRequest(&$request)
    {
        ...
        $conatiner = config('trucker.query_condition.get_array_params.container_parameter');
        $property = config('trucker.query_condition.get_array_params.property');
        $operator = config('trucker.query_condition.get_array_params.operator');
        $value = config('trucker.query_condition.get_array_params.value');
        ...
        if (isset($this->logicalOperator)) {
            $query->add(
                config('trucker.query_condition.get_array_params.logical_operator'),
    ...
    public function toArray()
    {
        ...
        if (isset($this->logicalOperator)) {
            $params[config('trucker.query_condition.get_array_params.logical_operator')] = $this->logicalOperator;
        }
